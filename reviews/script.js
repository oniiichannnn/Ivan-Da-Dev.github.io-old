const anime_lists = [
    ...
    },
    {
        ...
        img: "https://m.media-amazon.com/images/M/MV5BZGVlY2ZhM2ItMWIwZC00YjU0LWJjNjAtZGVlNWJkM2JmZjhmXkEyXkFqcGdeQXVyMzgxODM4NjM@._V1_.jpg",
        bg: "https://wallpapercave.com/wp/wp2475709.png"
    },
    {
        ...
        img: "https://i.pinimg.com/originals/70/dc/b1/70dcb1b6e4a6199ac0304b77b053ab69.jpg",
        bg: "https://pm1.narvii.com/5677/69bb5902f9d5a905c076ac78e2a785dbb0211fa6_hq.jpg"
    },
    {
...
document.addEventListener("click", function(element){
    ...
    const imageReg = /(@https?:\/\/(www\.)?[-a-zA-Z0-9:%._\+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9():%_\+.~#?&//=]*)\@|@\.\/images\/[a-zA-Z0-9, \w\.(jpe?g|png|gif|bmp|jfif)$]+@)/g
    ...
    if(imageReg.test(anime.review) === true){
        ...
        .replace(imageReg,function(text){
            console.log(text)
            return `<br><br><span class='attachment_ctn'><img class="attachment" src="${text.split('@')[1].split('@')[0]}"></span><br>`
        })
    }
    ...
    document.getElementById("view_img").src = anime.img
