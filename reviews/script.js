...
function display_anime(anime){
    ...
    `
     ...
     this.page.url = "${document.URL.replace(/\&scroll=[0-9]+/,'')}";  // Replace PAGE_URL with your page's canonical URL variable
     this.page.identifier = "${encodeURL(anime.title)}"; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
     };
